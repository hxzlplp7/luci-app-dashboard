...
var ke = (e, a, o) =>
  ...
  J = (e, a) => {
    ...
    if (Ge) for (var o of Ge(a)) ya.call(a, o) && ke(e, o, a[o]);
    return e;
  },
  at = (e, a) => xa(e, ka(a));
var Fa = (e, a) => () => (
...
var eF = Fa((Kt) => {
          ...
          T(this, null, function* () {
            try {
              ...
              ((a = `${c.baseURL || ""}${a}`),
                ...
                c.headers && (o.headers = J({}, c.headers)));
  ...
  const Qa = () => {
    ...
    const o = le(),
      ...
      c = function () {
        return S.Network.Status.GET()
          .then((p) => {
            if (p != null && p.data) {
              const { result: f } = p == null ? void 0 : p.data;
  ...
  const dashboardFeatureEnabled = (e) =>
    !Array.isArray(window.dashboard_features) ||
    window.dashboard_features.indexOf(e) != -1;
  const to = P({
    setup(e) {
      const a = Ke(),
        ...
        w(n)
          ? (i(),
            r(
              ...
              [
                t("div", null, h(c(w(o).duplex)), 1),
                t("div", null, "名称：" + h(w(o).name || "--"), 1),
                t("div", null, "MAC 地址：" + h(w(o).macAddress || "--"), 1),
                t("div", null, "下行流量：" + h(w(o).rx_packets || "--"), 1),
                t("div", null, "上行流量：" + h(w(o).tx_packets || "--"), 1),
              ],
              36,
            ))
          : C("", !0);
  ...
  var eo = Y(to, [["__scopeId", "data-v-57f1326f"]]);
  const ao = {
      id: "main",
    },
    oo = P({
  ...
  var no = Y(oo, [["__scopeId", "data-v-9bc295c2"]]);
  const io = {},
    ro = {
      t: "1640593669834",
      class: "icon",
  ...
  var ta = Y(gn, [["__scopeId", "data-v-733828e1"]]);
  const _n = {},
    hn = {
      t: "1649907260906",
  ...
  var ea = Y(Sn, [["__scopeId", "data-v-20f08566"]]);
  const zn = {},
    Pn = {
      t: "1641369474206",
      class: "icon",
          ...
          M(Wn, null, {
            default: V(() => [
              t(
                ...
                [
                  t("div", Hn, [
                    t("div", Zn, [Dt(n.$slots, "default", {}, void 0, !0)]),
                  ]),
                ],
              ),
            ]),
  ...
  var Xn = Y(Jn, [["__scopeId", "data-v-123deb20"]]);
    ...
    ni = P({
      ...
      setup(e, { emit: a }) {
        const o = e,
          ...
          p = (l) => {
            l === n.value ||
              (n.value === "useInput" && l === s.value) ||
              (l === "" || o.options.some((u) => u.key === l)
                ? (n.value = l)
                : ((s.value = l), (n.value = "useInput")));
          };
        (Ca(
          () => o.modelValue,
          (l) => {
  ...
  var Tt = Y(ni, [["__scopeId", "data-v-169d5b59"]]);
  const ii = {
      t: "1631799919469",
      class: "icon",
  ...
  var si = Y(ri, [["__scopeId", "data-v-0a8a31e2"]]);
  const di = {},
    ui = {
      t: "1642063181211",
      class: "icon",
  ...
  //}
  // });
  var Ei = Y(Fi, [["__scopeId", "data-v-7fc1a08c"]]),
    aa = {
      install: (e) => {
        (e.component("icon-loading", si),
          e.component("icon-success", fi),
          e.component("icon-error", hi),
          e.component("GlHelp", Ei));
      },
    };
  const Ci = (e) => {},
    $i = () => new Date().getTime(),
    ...
    zi = (e) =>
      e.length < 3
        ...
        : e.toLowerCase() != e
          ? "Username can only be in lowercase"
          : new RegExp("^\\d").exec(e)
      ...
      setup(e) {
        ...
        const a = y(),
          o = (_) => {
            ...
            return !v || v.startTime == 0
              ? ""
              : d(v.startTime * 1e3) + "-" + d(v.endTime * 1e3);
          },
          n = R(() => {
            var v;
            let _ = [];
              ...
              try {
                ...
                if (v.data && (_ = v.data.result) != null && _.items) {
                  ...
                  if (v.data.result.items.length < g) {
                    ...
                    v.data.result.items.length > g
                      ? (a.value = v.data.result.items.slice(
                          g - v.data.result.items.length,
                        ))
                      : (a.value = v.data.result.items);
                }
              } catch (v) {
                console.log(v);
              }
              ...
              formatter: (v) => {
                if (Array.isArray(v)) {
                  ...
                  for (let k = 0; k < v.length; k++)
                    g = `${g}<br>${v[k].seriesName}: ${l(v[k].value)}/s`;
                  return g.toString();
                } else {
                  const g = v;
        ...
        return (
          ...
          (_, v) => (
            ...
            r("div", Ii, [
              ...
              t("div", Li, [
                w(c) ? (i(), r("span", Mi, "上传: " + h(w(c)), 1)) : C("", !0),
                w(p) ? (i(), r("span", Oi, "下载: " + h(w(p)), 1)) : C("", !0),
              ]),
            ])
          )
        );
  ...
  var qi = Y(Ni, [["__scopeId", "data-v-e8f7c118"]]);
  const Vi = {},
    Gi = {
      t: "1649668202191",
      class: "icon",
  ...
  const Zi = {
      ...
      methods: {
        Stop() {
          this.type != "loading" &&
            ((this.show = !1), se != 0 && clearTimeout(se), this.Close());
        },
      },
    },
        ...
        T(Kt, null, function* () {
          ...
          try {
            ...
            if ((n.Close(), s != null && s.data)) {
              const { result: c, error: p } = s.data;
              if (p) F.Warning(p);
              else if (c) {
                if (c.status == "installed") return !0;
                if (
                  confirm(
                    `It has been detected that you have 未安装 ${a} plug-in, do you want to install it?`,
                  )
                ) {
                  n = F.Loading("正在安装...");
                  ...
                  F.Error(
                    "Installation failed or timed out, please check the software sources or try again later",
                  );
                }
  ...
  var Fr = Y(yr, [["__scopeId", "data-v-428d873e"]]);
  const et = P({
      props: {
        Close: {
          type: Function,
          ...
          m = () =>
            T(this, null, function* () {
              ...
              switch (p.value.dnsProto) {
                ...
                case "manual":
                  ((v.manualDnsIp = []),
                    p.value.manualDnsIp != null &&
                    p.value.manualDnsIp.length > 0
                      ? (v.manualDnsIp = p.value.manualDnsIp)
                      : (v.manualDnsIp.push(f.value),
                        d.value && v.manualDnsIp.push(d.value)));
                  break;
              }
              ((v.dnsProto = p.value.dnsProto),
                (v.interfaceName = p.value.interfaceName));
              const g = F.Loading("Configuration...");
              try {
                const k = yield S.Guide.DnsConfig.POST(v);
                if (k != null && k.data) {
                  const { success: x, error: E } = k == null ? void 0 : k.data;
                  (E && (l.value = E),
                    (x == null || x == 0) &&
                      (F.Success("配置成功"), (o.value = 1)));
                }
              } catch (k) {
                l.value = k;
              }
  ...
  var Jr = Y(Zr, [["__scopeId", "data-v-c4cdcce6"]]);
  const oa = () => {
  ...
  var rs = Y(is, [["__scopeId", "data-v-0ae97e7e"]]),
    ss = (e) => {
    ...
    bs = P({
      ...
      setup(e) {
        const a = e,
          ...
          s = (p) => {
            const f = p.target,
              { left: d, top: l } = f.getBoundingClientRect();
            ((o.portitemStyle.show = !0),
              (o.portitemStyle.left = d),
              (o.portitemStyle.top = l),
                          ...
                          h(e.item.name) +
                            ...
                            h(
                              e.item.interfaceNames
                                ? `(${e.item.interfaceNames.join(",").toLocaleUpperCase()})`
                                : "",
                            ),
                          1,
                        ),
                ...
                : (i(),
                  r(
                    ...
                    [
                      ps,
                      t("div", fs, [
                        t("div", null, h(e.item.linkSpeed), 1),
                        t(
                          "div",
                          ms,
                          h(e.item.name) +
  ...
  var na = Y(bs, [["__scopeId", "data-v-39248365"]]);
  ...
  var ks = Y(xs, [["__scopeId", "data-v-3470ca08"]]);
  const ws = {},
    ys = {
      width: "82px",
      height: "82px",
  ...
  const Rt = (e) => (O("data-v-1e29113c"), (e = e()), N(), e),
    ...
    Ls = Rt(() =>
      t(
        ...
        "Please select a software source",
        -1,
      ),
    ),
    Ms = ["value"],
    ...
    Us = P({
      ...
      setup(e) {
        const a = e,
          ...
          c = y();
        (() => {
          S.Guide.SoftSourceList.GET()
            .then((u) => {
              var m, b;
              if ((m = u == null ? void 0 : u.data) != null && m.result) {
                const _ =
                  (b = u == null ? void 0 : u.data) == null ? void 0 : b.result;
                c.value = _;
              }
            })
            .then(() => S.Guide.GetSoftSource.GET())
            .then((u) => {
              var m, b;
              if ((m = u == null ? void 0 : u.data) != null && m.result) {
                ...
                ((s.value = _.softSource),
                  (b = c.value) != null &&
                    b.softSourceList.find(
                      (v) => v.identity == _.softSource.identity,
                    ) &&
                            ...
                            t("div", Ys, [
                              ...
                              t("div", Ss, [
                                t(
                                  "p",
                                  zs,
                                  h((b = s.value) == null ? void 0 : b.name),
                                  1,
                                ),
                              ]),
                            ]),
  ...
  var Ws = Y(Us, [["__scopeId", "data-v-1e29113c"]]);
  const ra = () => {
      const e = document.createElement("div");
      document.body.appendChild(e);
      const a = tt(Ws, {
    ...
    Hd = P({
      ...
      setup(e) {
        const a = () => {
          ...
          b = () => {
            S.Network.PortList.GET()
              .then(($) => {
                if ($ != null && $.data) {
                  const { result: q } = $ == null ? void 0 : $.data;
        ...
        const v = yt.stampForm,
          ...
          A = () =>
            T(this, null, function* () {
              ...
              if (
                (k(),
                yield ct.checkAndInstallApp("app-meta-homebox", "Homebox"))
              )
                try {
                  const G = yield S.Network.Homebox.Enable.POST();
                  (q =
                    ($ = G == null ? void 0 : G.data) == null
                      ? void 0
                      : $.result) != null && q.port
                    ? ss({
            ...
            r(
              ...
              [
                                  ...
                                  r("div", Xs, [
                                    ...
                                    t("div", Qs, [
                                      ...
                                      t(
                                        "span",
                                        ed,
                                        h(w(v)(w(s).uptimeStamp)),
                                        1,
                                      ),
                                    ]),
                                  ]))
                                : w(s).networkInfo == "dnsFailed"
                                  ? (i(),
                                    r("div", ad, [
                                      od,
                                      t("div", nd, [
                ...
                t("div", Sd, [
                  ...
                  t("div", Ld, [
                    t("span", null, "IPv6\uFF1A" + h(w(s).ipv6addr), 1),
                  ]),
                  t("div", IPd, [
                    t("span", null, "公网\uFF1A" + h(w(s).ipv6addr), 1),
                  ]),
                  t("div", Md, [
                    t(
                      "span",
                      null,
                      "DNS\uFF08" + h(m(w(s).dnsProto)) + "\uFF09",
                      1,
                    ),
                  ]),
                  (i(!0),
                  r(
                    ...
                    j(
                      w(s).dnsList,
                      (ht) => (i(), r("div", Od, [t("span", null, h(ht), 1)])),
                    ),
                    256,
                  )),
                ]),
  ...
  var Zd = Y(Hd, [["__scopeId", "data-v-fd7a24a6"]]);
  const Jd = {
    ...
    t0 = P({
      setup(e) {
        return (a, o) => (
          i(),
          r("div", Jd, [
            t("div", Xd, [t("div", Kd, [D(qi)])]),
            t("div", Qd, [D(Zd)]),
          ])
        );
      },
    });
  var e0 = Y(t0, [["__scopeId", "data-v-6cd42792"]]);
  const a0 = {},
    o0 = {
      width: "14px",
      height: "14px",
  ...
  const s0 = {},
    ...
    u0 = Mt(
      '<title>Partition information</title><g id="icon_info" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd"><g id="Group"><circle id="Oval" stroke="#333333" cx="9" cy="9" r="8.5"></circle><circle id="Oval" fill="#333333" cx="5" cy="9" r="1"></circle><circle id="Oval" fill="#333333" cx="9" cy="9" r="1"></circle><circle id="Oval" fill="#333333" cx="13" cy="9" r="1"></circle></g></g>',
      2,
    ),
    l0 = [u0];
      ...
      setup(e) {
        const a = e,
          ...
          b = () => {
            ...
            const E = a.mount;
            if (
              (E != null && E.mountPoint != null && (x = E.mountPoint), x != "")
            ) {
              s(x);
              return;
            }
          ...
          _ = () => {
            ...
            if (E) {
              ...
              if (
                !confirm(
                  `WARNING: Format will remove ${A} partition data, please operate with caution`,
                ) ||
                !confirm(`Are you sure to format ${A}?`)
              )
                return;
              g(E);
              return;
            ...
            if (x) {
              if (
                !confirm(
                  `警告：此操作将初始化 ${x.venderModel} 硬盘并创建分区，请谨慎操作`,
                ) ||
                !confirm("确定要初始化吗？")
              )
                return;
          ...
          v = (x) =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (A != null && A.data) {
                  const { result: B, error: $ } = A == null ? void 0 : A.data;
                  ($ && F.Warning($),
                    B &&
                      (B.errorInfo
                        ? F.Warning(B.errorInfo)
                        : (F.Success("初始化成功"),
                          B.childrens &&
                            B.childrens.length > 0 &&
                            (u.value = B.childrens[0]),
                          (l.value = B),
                          f(1))));
                }
              } catch (A) {
            ...
            T(this, null, function* () {
              ...
              try {
                ...
                if (A != null && A.data) {
                  const { result: B, error: $ } = A == null ? void 0 : A.data;
                  ($ && F.Warning($),
                    B && (F.Success("格式化成功"), (u.value = B), f(1)));
                }
              } catch (A) {
                F.Error(A);
              }
                                      ...
                                      d.value == "format"
                                        ? (i(),
                                          r(
                                            "p",
                                            I0,
                                            "Formatted as EXT4 file system, the transfer speed is faster",
                                          ))
                                        : d.value == "default"
                                          ? (i(), r("p", L0))
                                          : C("", !0),
                                ...
                                t("div", G0, [
                                  ...
                                  l.value
                                    ? (i(),
                                      r("div", U0, [
                                        U(
                                          h(l.value.venderModel) +
                                            " has been successfully formatted and mount to ",
                                          1,
                                        ),
                                        t(
                                          "a",
                                  ...
                                  u.value
                                    ? (i(),
                                      r("div", W0, [
                                        H0,
                                        t("a", null, h(u.value.mountPoint), 1),
                                      ]))
                                    : C("", !0),
                                  t("div", Z0, [
                                    t(
  ...
  var X0 = Y(J0, [["__scopeId", "data-v-3a0bca4c"]]),
    Be = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
          ...
          u = () =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (k != null && k.data) {
                  const { result: x, error: E } = k == null ? void 0 : k.data;
                  (E && F.Warning(E),
                    x && (F.Success("挂载成功"), (l.value = x), d(1)));
                }
              } catch (k) {
                F.Error(k);
              }
                                    ...
                                    ? (i(),
                                      r("div", hu, [
                                        U(
                                          "Partition " +
                                            h(l.value.path) +
                                            " was successful mounted to ",
                                          1,
                                        ),
                                        t("a", null, h(l.value.mountPoint), 1),
                                      ]))
                                    : C("", !0),
                                  t("div", xu, [
                                    t(
  ...
  var wu = Y(ku, [["__scopeId", "data-v-57d4812a"]]),
    sa = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
          ...
          p = () =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (u != null && u.data) {
                  const { result: m, error: b } = u == null ? void 0 : u.data;
                  (b && F.Warning(b),
                    m && (F.Success("Mounted uccessfully"), location.reload()));
                }
              } catch (u) {
                F.Error(u);
              }
            ...
            r("div", yu, [
              t("li", Fu, [
                t("div", Eu, [
                  ...
                  e.part.isSystemRoot
                    ? (i(), r("span", Du, " (System partition)"))
                    : C("", !0),
                ]),
                t("div", Bu, [
                  e.part.mountPoint || w(f)
                    ? (i(),
                      r("div", Yu, [
                        t("div", Au, [
                          D(
                    ...
                    t("div", Iu, [
                      t("div", Lu, [
                        t(
                          "div",
                          null,
                          "磁盘状态：" + h(e.part.isReadOnly ? "只读" : "读写"),
                          1,
                        ),
  ...
  var ju = Y(Gu, [["__scopeId", "data-v-31be4af0"]]);
  const ua = (e) => (O("data-v-5fa713aa"), (e = e()), N(), e),
    ...
    Wu = ua(() =>
      t(
        ...
        [
          t("span", null, "Partition / Mount point"),
          t("span", null, "Capacity"),
        ],
        -1,
      ),
    ),
  ...
  var Xu = Y(Ju, [["__scopeId", "data-v-5fa713aa"]]),
    Ku = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
  ...
  const fe = (e) => (O("data-v-eb0dbbd8"), (e = e()), N(), e),
      ...
      t(
        ...
        [
          t(
            ...
            {
              href:
                (window.vue_base || "/cgi-bin/luci/admin/dashboard/") + "smart",
            },
            [
              t(
                "span",
    ...
    pl = fe(() =>
      t(
        ...
        [t("span", null, "Only count mounted partitions")],
        -1,
      ),
    ),
    fl = {
          ...
          t(
            ...
            [
              t(
                ...
                "系统空间不足。检测到您的 Docker 根目录位于系统分区上, 这可能会影响系统正常运行。建议使用 Docker 迁移向导 to 将 Docker 目录迁移到外部硬盘。",
              ),
            ],
          ),
        ],
          ...
          t(
            ...
            [
              t(
                ...
                "There is an exception in partition, click partition list to view the error",
              ),
            ],
          ),
        ],
          ...
          return w(o) == "error"
            ? (i(),
              r("li", Qu, [
                ...
                t("div", el, [
                  t("div", al, [t("span", ol, h(e.disk.errorInfo), 1)]),
                ]),
              ]))
            : w(o) == "success"
              ? (i(),
                    ...
                    : (i(),
                      r("div", ul, [
                        ...
                        t("div", fl, [
                          ...
                          e.disk.usage &&
                          e.disk.usage >= 90
                            ? (i(), r("span", ml, [t("span", bl, [D(gt)]), vl]))
                            : C("", !0),
                          !e.disk.isSystemRoot &&
                          (((u = e.disk.childrens) == null
                            ? void 0
                            : u.filter(
                                (g) => g.isReadOnly || g.filesystem == "ntfs",
                              ).length) || 0) > 0
                            ? (i(), r("span", gl, [t("span", _l, [D(gt)]), hl]))
                            : C("", !0),
                          !e.disk.isSystemRoot &&
                          (((m = e.disk.childrens) == null
                            ? void 0
                            : m.filter(
                                (g) => g.isReadOnly || g.filesystem == "ntfs",
                              ).length) || 0) > 0
                ...
                : w(o) == "unmounted"
                  ? (i(),
                    r("li", El, [
                      ...
                      t("div", $l, [
                        ((b = e.disk.childrens) == null ? void 0 : b.length) ==
                        1
                          ? (i(),
                            r("div", Dl, [
                              t("div", Bl, [
                          ...
                          : C("", !0),
                        (((_ = e.disk.childrens) == null ? void 0 : _.length) ||
                          0) > 1
                          ? (i(),
                            r("div", Yl, [
                              t("div", Al, [
  ...
  var we = Y(zl, [["__scopeId", "data-v-eb0dbbd8"]]);
        ...
        [
          t("li", null, [
            t(
              ...
              {
                href:
                  (window.vue_base || "/cgi-bin/luci/admin/dashboard/") +
                  "smart",
              },
              "S.M.A.R.T",
            ),
        ...
        ((() =>
          T(this, null, function* () {
            try {
              ...
              if (f != null && f.data) {
                const { success: d, error: l, result: u } = f.data;
            ...
            r("div", Pl, [
              t("ul", null, [
                ...
                w(o).disks
                  ...
                  : C("", !0),
                w(o).raidList && w(o).raidList.length > 0
                  ? (i(),
                    r("li", Xl, [
                      Kl,
                      t("div", Ql, [
  ...
  var e1 = Y(t1, [["__scopeId", "data-v-40555016"]]);
  ...
  var p1 = Y(c1, [["__scopeId", "data-v-13ca629c"]]);
                        ...
                        t(
                          "a",
                          {
                            ...
                            href:
                              "/cgi-bin/luci/admin/system/filebrowser#" +
                              encodeURIComponent(
                                (f = e.webdav) == null ? void 0 : f.path,
                              ),
                          },
                          h((d = e.webdav) == null ? void 0 : d.path),
                          9,
                          h1,
                        ),
                      ]),
                    ...
                    r("li", F1, [
                      ...
                      t("div", C1, [
                        t(
                          "span",
                          null,
                          h((m = e.webdav) == null ? void 0 : m.username),
                          1,
                        ),
                      ]),
                    ]))
  ...
  var D1 = Y($1, [["__scopeId", "data-v-b4608492"]]);
      ...
      setup(e) {
        ...
        a.currDisk != null &&
          ((s = a.currDisk) == null ? void 0 : s.venderModel) ==
            ((c = a.disk) == null ? void 0 : c.venderModel) &&
          (o.value = !0);
        const n = (p) => {
            ...
            r("ul", B1, [
              t(
                "li",
                {
                  class: ot([
                    "disk-info",
                    {
                      on:
                        e.disk.venderModel ==
                        ((d = e.currDisk) == null ? void 0 : d.venderModel),
                      nopoint:
                ...
                [
                  Y1,
                  t("div", A1, [
                    t("div", S1, h(e.disk.venderModel), 1),
                    t("div", z1, h(e.disk.used) + "/" + h(e.disk.size), 1),
                  ]),
                  P1,
                  t("div", T1, h(e.disk.path), 1),
                ],
                2,
              ),
              z(
                            ...
                            "li",
                            {
                              class: ot([
                                "disk-children_item",
                                {
                                  on:
                                    l.uuid ==
                                      ((u = e.currMountPoint) == null
                                        ? void 0
                                        : u.uuid) &&
                                    l.path ==
                                      ((m = e.currMountPoint) == null
                                        ? void 0
                                        : m.path),
                                },
                              ]),
  ...
  var We = Y(q1, [["__scopeId", "data-v-4a3b6e0a"]]);
      ...
      setup(e) {
          ...
          T(this, null, function* () {
            ...
            try {
              ...
              _ != null &&
                ...
                _.value.data.result &&
                (n.disks =
                  (_.value == null ? void 0 : _.value.data.result.disks) || []);
              g != null &&
                g.status === "fulfilled" &&
                g.value &&
                g.value.data.result &&
                (n.raids = g.value.data.result.disks || []);
        ...
        const c = y(),
          ...
          m = () => {
            ...
            if (
              c.value.childrens != null &&
              c.value.childrens.length > 0 &&
              p.value == null
            ) {
            ...
            if (
              p.value != null &&
              (p.value.mountPoint == null || p.value.mountPoint == "")
            ) {
              F.Warning(
                "The partition has not been mounted yet, please mount it first",
              );
              return;
            }
            ((o.value = !1),
  ...
  var Z1 = Y(H1, [["__scopeId", "data-v-12d0f96b"]]),
    J1 = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
        ...
        (() => {
          S.Nas.Linkease.Enable.POST().then((p) => {
            ...
            (f = p == null ? void 0 : p.data) != null &&
              f.result &&
              (o.value = ((d = p.data.result) == null ? void 0 : d.port) || "");
          });
        })();
        const c = () => {
          (a.Close && a.Close(), location.reload());
  ...
  var rc = Y(ic, [["__scopeId", "data-v-67a63e8f"]]),
    sc = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
        ...
        (() =>
          T(this, null, function* () {
            ...
            try {
              ...
              if (l != null && l.data) {
                const { result: u, error: m } = l.data;
                if (m) {
                  F.Warning(m);
                  return;
                }
                u &&
                  (u.username && (s.value.username = u.username),
                  u.password && (s.value.password = u.password));
              }
            } catch (l) {
              F.Error(l);
            }
          ...
          f = (d) =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (u != null && u.data) {
                  const { error: m, result: b } = u.data;
                  (m && F.Warning(m),
                    b &&
                      (F.Success("Created successfully"),
                      window.setTimeout(() => {
                        location.reload();
                      }, 1e3)));
                }
  ...
  var Cc = Y(Ec, [["__scopeId", "data-v-30ef6ccb"]]),
    $c = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
  ...
  var a2 = Y(e2, [["__scopeId", "data-v-3ef9e48f"]]),
    o2 = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
  ...
  var h2 = Y(_2, [["__scopeId", "data-v-650e3bd4"]]),
    ca = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
  ...
  var A2 = Y(Y2, [["__scopeId", "data-v-edf68726"]]);
  ...
  var V2 = Y(q2, [["__scopeId", "data-v-8376a10e"]]);
          ...
          s = () =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (p != null && p.data) {
                  const { success: f, error: d } = p.data;
        ...
        return (p, f) => {
          ...
          return (
            ...
            r("ul", G2, [
              ...
              ((l = e.docker) == null ? void 0 : l.status) == "运行中"
                ? (i(),
                  r("li", t6, [
                    e6,
                    t("div", a6, [
                      t(
                        "span",
                        o6,
                        h((u = e.docker) == null ? void 0 : u.path),
                        1,
                      ),
                      (m = e.docker) != null && m.errorInfo
                        ? (i(),
                          r("span", n6, [
                            t("span", i6, [
                              t("span", r6, [D(gt)]),
                              t("div", null, [
                                t("div", s6, [
                                  t("span", d6, h(e.docker.errorInfo), 1),
                                ]),
                              ]),
                            ]),
                          ]))
  ...
  var l6 = Y(u6, [["__scopeId", "data-v-3fd3a42d"]]);
  const c6 = {},
    p6 = {
      width: "128px",
      height: "128px",
  ...
  const pt = (e) => (O("data-v-b8b2bddc"), (e = e()), N(), e),
    ...
    h6 = pt(() =>
      t(
        ...
        "当系统根目录空间不足时，可以将 Docker 根目录迁移到外部硬盘，以确保 Docker 系统的正常运行。",
        -1,
      ),
    ),
    x6 = {
    ...
    A6 = pt(() =>
      t(
        ...
        "Please select a re-location address",
        -1,
      ),
    ),
    S6 = ["value"],
    ...
    I6 = pt(() =>
      t(
        ...
        "检测到您未挂载外部硬盘，您需要连接硬盘并格式化或手动挂载硬盘，然后执行 Docker 迁移向导将 Docker 迁移到目标硬盘。",
        -1,
      ),
    ),
    L6 = {
    ...
    Z6 = pt(() =>
      t(
        ...
        [
          t("li", { class: "option_title" }, "替换目录"),
          t(
            "li",
            { class: "option_info" },
            "不覆盖目标路径，仅将 Docker 目录修改为目标路径",
          ),
        ],
        -1,
      ),
    ...
    X6 = pt(() =>
      t(
        ...
        [
          t("li", { class: "option_title" }, "Overwrite migration"),
          t(
            "li",
            { class: "option_info" },
            "Overwrite the target path, continuing to migrate will clear files under target path",
          ),
        ],
        -1,
      ),
      ...
      setup(e) {
        ...
        (() => {
          (S.Nas.Disk.Status.GET().then((x) => {
            x != null &&
              x.data.result &&
              (f.value = x == null ? void 0 : x.data.result);
          }),
                            ...
                            [
                              ...
                              t("div", y6, [
                                ...
                                t(
                                  "span",
                                  E6,
                                  h((A = o.value) == null ? void 0 : A.path),
                                  1,
                                ),
                              ]),
                              t("div", C6, [
                                ...
                                ($ =
                                                ...
                                                ? z(
                                                    ...
                                                    r(
                                                      "input",
                                                      {
                                                        ...
                                                        required: "",
                                                        placeholder:
                                                          "Please enter migration address",
                                                      },
                                                      null,
                                                      512,
                                                    )),
                                  ...
                                  : n.value
                                    ? (i(), r("div", P6, [t("div", T6, [I6])]))
                                    : C("", !0),
                              ]),
                            ],
                          ),
                          (G =
                            (H = n.value) == null ? void 0 : H.partitionList) !=
                            null && G.length
                            ? (i(),
                              r("div", L6, [
                                t(
  ...
  var t5 = Y(Q6, [["__scopeId", "data-v-b8b2bddc"]]);
  const e5 = () => {
      const e = document.createElement("div");
      document.body.appendChild(e);
      const a = tt(t5, {
              ...
              r("div", a5, [
                t("div", o5, [
                  ...
                  a.value
                    ? (i(),
                      r("div", i5, [
                        ((m = o.value) == null ? void 0 : m.status) != "未安装"
                          ? (i(),
                            r(
                              "div",
                              {
                          ...
                          : C("", !0),
                        dockerOverviewFeature &&
                        ((b = o.value) == null ? void 0 : b.status) != "未安装"
                          ? (i(),
                            r("span", r5, [
                              D($t, {
                                onClick: s,
  ...
  var c5 = Y(l5, [["__scopeId", "data-v-223bcc06"]]);
          ...
          return (
            ...
            r("ul", p5, [
              t("li", f5, [
                m5,
                t("div", b5, [
                  ((p = e.aria2) == null ? void 0 : p.status) == "运行中"
                    ? (i(), r("span", v5, "\u5DF2\u542F\u52A8"))
                    : (i(), r("span", g5, "\u672A\u542F\u52A8")),
                ]),
              ]),
              ((f = e.aria2) == null ? void 0 : f.status) == "运行中"
                ? (i(),
                  r(
                    L,
                    {
                      ...
                      t("li", _5, [
                        ...
                        t("div", x5, [
                          t(
                            ...
                            h((l = e.aria2) == null ? void 0 : l.downloadPath),
                            9,
                            k5,
                          ),
                        ]),
  ...
  var S5 = Y(A5, [["__scopeId", "data-v-dbe287b2"]]);
          ...
          return (
            ...
            r("ul", z5, [
              t("li", P5, [
                T5,
                t("div", I5, [
                  ((c = e.qbittorrent) == null ? void 0 : c.status) == "运行中"
                    ? (i(), r("span", L5, "\u5DF2\u542F\u52A8"))
                    : (i(), r("span", M5, "\u672A\u542F\u52A8")),
                ]),
              ]),
              ((p = e.qbittorrent) == null ? void 0 : p.status) == "运行中"
                ? (i(),
                  r(
                    L,
                    {
  ...
  var Z5 = Y(H5, [["__scopeId", "data-v-1af61e64"]]);
          ...
          return (
            ...
            r("ul", J5, [
              t("li", X5, [
                K5,
                t("div", Q5, [
                  ((c = e.transmission) == null ? void 0 : c.status) == "运行中"
                    ? (i(), r("span", t3, "\u5DF2\u542F\u52A8"))
                    : (i(), r("span", e3, "\u672A\u542F\u52A8")),
                ]),
              ]),
              ((p = e.transmission) == null ? void 0 : p.status) == "运行中"
                ? (i(),
                  r(
                    L,
                    {
  ...
  var c3 = Y(l3, [["__scopeId", "data-v-31717210"]]);
  const p3 = {},
    f3 = {
      width: "14px",
      height: "14px",
      ...
      setup(e) {
        ...
        Ft(() => {
          ...
          ((b.value = a.partitionList.map((Ht) => ({
            ...
            (_.value = a.partitionList
              .filter((Ht) => Ht.startsWith("/mnt/"))
              .map((Ht) => Ht.replace(/(\/mnt\/[^/]+).*/, "$1"))),
            (s.value =
              ((G = a.services.aria2) == null ? void 0 : G.configPath) || ""));
          const B =
            ((Z = a.services.aria2) == null ? void 0 : Z.downloadPath) ||
            ((ht = a.services.qbittorrent) == null
              ? void 0
              : ht.downloadPath) ||
            ((Ie = a.services.transmission) == null ? void 0 : Ie.downloadPath);
          B && (c.value = B);
          ...
          ($ && (o.value = $),
            (d.value =
              ((Me = a.services.qbittorrent) == null
                ...
                : Me.configPath) || ""));
          const q =
            ((Oe = a.services.qbittorrent) == null
              ? void 0
              : Oe.downloadPath) ||
            B ||
            ((Ne = a.services.transmission) == null ? void 0 : Ne.downloadPath);
          (q && (l.value = q),
            (u.value =
              ((qe = a.services.transmission) == null
                ? void 0
                : qe.configPath) || ""));
          const H =
            ((Ve = a.services.transmission) == null
              ? void 0
              : Ve.downloadPath) ||
            B ||
            q;
  ...
  var S4 = Y(A4, [["__scopeId", "data-v-378dba8e"]]);
  const z4 = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
              ...
              t("div", V4, [
                t("ul", G4, [
                  ...
                  t(
                    ...
                    {
                      onClick:
                        _[2] || (_[2] = (E) => (a.value = "transmission")),
                      class: ot({
                    ...
                    ? (i(),
                      M(
                        Z5,
                        {
                          key: 1,
                          qbittorrent:
                            (k = o.value) == null ? void 0 : k.qbittorrent,
                        },
                        null,
                        8,
                        ["qbittorrent"],
                      ...
                      ? (i(),
                        M(
                          c3,
                          {
                            key: 2,
                            transmission:
                              (x = o.value) == null ? void 0 : x.transmission,
                          },
                          null,
                          8,
                          ["transmission"],
  ...
  var R4 = Y(j4, [["__scopeId", "data-v-23580536"]]);
  ...
  var d8 = Y(s8, [["__scopeId", "data-v-43beecef"]]);
  ...
  var h8 = Y(_8, [["__scopeId", "data-v-43dd65a2"]]);
  const ap = {
      class: "action-main",
    },
    op = P({
                      ...
                      t(
                        ...
                        [
                          t(
                            "p",
                            null,
                            "\u7B2C\u4E09\u65B9\u7A7F\u900F\u5411\u5BFC\u5DF2\u79FB\u9664\u3002\u8BF7\u4F7F\u7528 DDNS \u914D\u7F6E\u5411\u5BFC\u6216\u201C\u670D\u52A1-\u52A8\u6001DNS\u201D\u9875\u9762\u5B8C\u6210\u8FDC\u7A0B\u57DF\u540D\u914D\u7F6E\u3002",
                          ),
                          t(
                            "a",
                            {
  ...
  var np = Y(op, [["__scopeId", "data-v-7a6bd385"]]);
  const ip = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
  ...
  var cp = Y(lp, [["__scopeId", "data-v-4358e88c"]]);
  const de = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
    ...
    Hp = P({
      ...
      setup(e, { emit: a }) {
        const o = e,
          ...
          m = () => {
            F.Warning(
              "\u5F53\u524D WAN \u53E3\u672A\u68C0\u6D4B\u5230\u516C\u7F51 IPv4 \u6216 IPv6 \u5730\u5740\uFF0CDDNS \u53EF\u80FD\u65E0\u6CD5\u5728\u516C\u7F51\u76F4\u63A5\u8BBF\u95EE",
            );
          },
          _ = () => {
            d.value = !0;
            ...
            S.Guide.PostDdns.POST({
              ...
              .then((g) => {
                if (g != null && g.data) {
                  const { error: k, scope: x, success: E } = g.data;
  ...
  var ye = Y(Hp, [["__scopeId", "data-v-9435cfa6"]]);
  const Zp = {
      class: "action-main",
    },
    Jp = P({
  ...
  var Xp = Y(Jp, [["__scopeId", "data-v-6f1d92d9"]]);
  const Kp = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
  ...
  var E7 = Y(F7, [["__scopeId", "data-v-6960b0be"]]);
  const C7 = {
      class: "nas-container",
    },
    $7 = {
    ...
    S7 = P({
      setup(e) {
        ...
        return (a, o) => (
          ...
          r("div", C7, [
            t("div", $7, [D(e1)]),
            w(Vt)("dockerd") ? (i(), r("div", B7, [D(c5)])) : C("", !0),
          ])
        );
      },
    });
  var z7 = Y(S7, [["__scopeId", "data-v-66cc4e33"]]);
      ...
      setup(e) {
        const a = Ce(),
          ...
          f = R(() => {
            var b;
            const m =
              ((b = n.value) == null ? void 0 : b.memAvailablePercentage) ||
              100;
            return 100 - m;
          }),
          d = yt.stampForm;
          ...
          return (
            ...
            r("div", P7, [
              ...
              t("div", J7, [
                X7,
                t("div", K7, [
                  t("span", null, h((v = w(o)) == null ? void 0 : v.model), 1),
                ]),
              ]),
              t("div", Q7, [
                tf,
                t("div", ef, [
                  t(
                    "span",
                    null,
                    h((g = w(o)) == null ? void 0 : g.firmwareVersion),
                    1,
                  ),
                ]),
              ]),
              t("div", af, [
                ...
                t("div", nf, [
                  t(
                    "span",
                    null,
                    h((k = w(o)) == null ? void 0 : k.kernelVersion),
                    1,
                  ),
                ]),
              ]),
              t("div", rf, [
                ...
                t("div", df, [
                  t(
                    "span",
                    null,
                    h(w(d)((x = w(n)) == null ? void 0 : x.uptime)),
                    1,
                  ),
                ]),
              ]),
              t("div", uf, [
                ...
                t("div", cf, [
                  t(
                    "span",
                    null,
                    h((E = w(n)) == null ? void 0 : E.localtime),
                    1,
                  ),
                ]),
              ]),
  ...
  var ff = Y(pf, [["__scopeId", "data-v-f3717996"]]);
  ...
  const mt = (e) => (O("data-v-a0faa6f2"), (e = e()), N(), e),
    ...
    Sf = mt(() =>
      t(
        ...
        [t("span", null, "IP Pool start address")],
        -1,
      ),
    ),
    zf = {
    ...
    Tf = mt(() =>
      t(
        ...
        [t("span", null, "IP Pool end address")],
        -1,
      ),
    ),
    If = {
    ...
    Nf = mt(() =>
      t(
        ...
        [t("span", null, "Change configuration")],
        -1,
      ),
    ),
    qf = {
    ...
    Qf = mt(() =>
      t(
        "p",
        null,
        "Router IP may have been modified successfully. If refreshing the page fails, please reconnect router, otherwise, please try to reconfigure.",
        -1,
      ),
    ),
    tm = P({
      ...
      setup(e) {
        ...
        (() => {
          S.Guide.GetLan.GET().then((g) => {
            g.data.result &&
              ((f.value = g.data.result.enableDhcp || !1),
              (g.data.result.enableDhcp = !1),
              (n.value = g.data.result),
              g.data.result.lanIp !== location.hostname && (l = !1));
          });
        })();
        const m = () => {
            const g = n.value;
          ...
          b = () => {
            ...
            if (
              (g.enableDhcp && !xt.isValidIP(g.dhcpStart)) ||
              !xt.isValidIP(g.dhcpEnd) ||
              !xt.isValidMaskRange(g.lanIp, g.netMask, g.dhcpStart, g.dhcpEnd)
            ) {
              F.Warning(
                "Format of DHCP IP Pool is wrong or exceeds range of the subnet",
              );
              return;
            }
                              ...
                              r("div", Df, [
                                D(
                                  ea,
                                  {
                                    ...
                                    "onUpdate:modelValue":
                                      k[2] ||
                                      (k[2] = (x) => (n.value.enableDhcp = x)),
                                  },
                                  {
                                    default: V(() => [
                                      n.value.enableDhcp
                                        ? (i(),
                                          r("span", Bf, "Edit DHCP service"))
                                        : (i(),
                                          r(
                                            "span",
                                            Yf,
                                            "Keep DHCP service settings",
                                          )),
                                    ]),
                                    _: 1,
                                  },
                            ...
                            ? (i(),
                              r("div", Vf, [
                                ...
                                t(
                                  ...
                                  "Jump to new address after " + h(p.value),
                                  9,
                                  Rf,
                                ),
                              ]))
                              ...
                              ? (i(),
                                r("div", Uf, [
                                  ...
                                  t(
                                    ...
                                    {
                                      class:
                                        "cbi-button cbi-button-positive app-btn",
                                      onClick: v,
                                    },
                                    "I see",
                                  ),
  ...
  var em = Y(tm, [["__scopeId", "data-v-a0faa6f2"]]);
  const am = () => {
      const e = document.createElement("div");
      document.body.appendChild(e);
      const a = tt(em, {
    ...
    rm = bt(() =>
      t(
        ...
        "A simple sandbox, which is convenient for experimenting with system configuration and programs, and for developing unfinished software, but does not protect Docker and hard disk data",
        -1,
      ),
    ),
    sm = {
              ...
              (p.value =
                (c.value &&
                  ((A =
                    (E = d.value) == null
                      ? void 0
                      : E.disks.find((B) => B.path == c.value)) == null
                    ? void 0
                    : A.childrens)) ||
                []));
          },
          ...
          g = (x) => {
            ...
            S.Nas.Sandbox.POST({
              ...
              .then((A) => {
                var B;
                if (A != null && A.data) {
                  if ((A.data.success || 0) == 0)
                    return ((o.value = 2), window.setTimeout(b, 1e3), u());
                            ...
                            ? (i(),
                              r(
                                ...
                                [
                                  ...
                                  d.value && d.value.disks.length == 0
                                    ? (i(), r("div", um, [D(gt), lm]))
                                    : C("", !0),
                                  d.value && d.value.disks.length > 0
                                    ? (i(),
  ...
  var Im = Y(Tm, [["__scopeId", "data-v-0384f3ac"]]);
  const Lm = () => {
      const e = document.createElement("div");
      document.body.appendChild(e);
      const a = tt(Im, {
      ...
      setup(e) {
        const a = e,
          ...
          c = () => {
            ...
            S.Nas.SandboxCommit.POST()
              .then((u) => {
                var m, b;
                if (u != null && u.data)
                  if (
                    (((m = u == null ? void 0 : u.data) == null
                      ? void 0
                      : m.success) || 0) == 0
                  ) {
              ...
              .then((u) => {
                ...
                if (u != null && u.data)
                  if (
                    ...
                    F.Loading(
                      "Restarting device... If the page has not been refreshed for a long time, you may need to manually fill in the address",
                    );
                    return;
                  } else
                    (b = u == null ? void 0 : u.data) != null &&
          ...
          f = () => {
            if (
              !confirm(
                "Are you sure you want to discard the data in the sandbox? Re-entering the sandbox requires reformatting the corresponding disk partition",
              )
            )
              return;
            n.value = !0;
            const l = F.Loading("\u6267\u884C\u4E2D...");
            S.Nas.SandboxExit.POST()
              .then((u) => {
                var m, b;
                if (u != null && u.data)
                  if (
  ...
  var Um = Y(Rm, [["__scopeId", "data-v-4db2efb4"]]);
  const Wm = () => {
      const e = document.createElement("div");
      document.body.appendChild(e);
      const a = tt(Um, {
      ...
      setup(e) {
        ...
        const s = y(),
          ...
          m = () => {
            var b, _, v, g;
            window.open(
              `${(_ = (b = window.dashboard_configs) == null ? void 0 : b.ttyd) != null && _.ssl ? "https" : "http"}://${window.location.hostname}:${((g = (v = window.dashboard_configs) == null ? void 0 : v.ttyd) == null ? void 0 : g.port) || 7681}/`,
              "_blank",
            );
          };
        return (
          Vt("sandbox") &&
            S.Nas.GetSandbox.GET()
              .then((_) => {
                var v, g, k;
                _ != null &&
                  _.data &&
                  ((((v = _ == null ? void 0 : _.data) == null
                    ? void 0
                    : v.success) || 0) == 0
                    ? (g = _ == null ? void 0 : _.data) != null &&
                      g.result &&
                      (s.value = _.data.result)
                    : (k = _ == null ? void 0 : _.data) != null &&
                      k.error &&
                      alert(_.data.error));
              })
              .catch((_) => F.Warning(_)),
  ...
  var n9 = Y(o9, [["__scopeId", "data-v-0d223b54"]]);
    ...
    l9 = P({
      setup(e) {
        return (
          ...
          (a, o) => (
            i(),
            r("div", i9, [r9, D(e0), s9, D(n9), D(z7), d9, D(ff), u9])
          )
        );
      },
    });
  var c9 = Y(l9, [["__scopeId", "data-v-08ce2a3e"]]);
  const p9 = {};
  ...
  const Wt = (e) => (O("data-v-082ffcaf"), (e = e()), N(), e),
    ...
    Z9 = Wt(() =>
      t(
        ...
        [
          U("Didn't find the desired configuration? Please use "),
          t(
            "a",
            {
  ...
  var X9 = Y(J9, [["__scopeId", "data-v-082ffcaf"]]);
  const St = (e) => (O("data-v-16746f19"), (e = e()), N(), e),
    ...
    tb = St(() =>
      t(
        ...
        "Please make sure you have connected the routing WAN port to the optical modem",
        -1,
      ),
    ),
    eb = {
    ...
    mb = St(() =>
      t(
        ...
        "Enable LAN port DHCP service ( Used to restore the default state from the bypass mode )",
        -1,
      ),
    ),
    bb = {
        ...
        (() =>
          T(this, null, function* () {
            ...
            try {
              ...
              if (m[0].data) {
                const { success: b, error: _, result: v } = m[0].data;
                (v && ((v.enableLanDhcp = !1), (o.value = v)),
                  b == -1011 && ((s.value = !0), (c.value = b)));
              }
              (l = m[1].data) != null &&
                l.result &&
                (((u = m[1].data) == null ? void 0 : u.result).enableDhcp ||
                  ((p.value = !0), (o.value.enableLanDhcp = !0)));
            } catch (m) {
              n.value = m;
            }
            c.value == 0 && (s.value = !1);
        ...
        const d = () =>
          T(this, null, function* () {
            ...
            try {
              ...
              if (b != null && b.data) {
                const { error: _, success: v } = b.data;
                (_ && (n.value = _),
                  (v == null || v == 0) &&
                    (F.Success("配置成功"), (a.value = 1)));
              }
            } catch (b) {
              n.value = b;
            }
                ...
                t(
                  ...
                  [
                    ...
                    p.value
                      ...
                      : C("", !0),
                    n.value ? (i(), r("div", bb, h(n.value), 1)) : C("", !0),
                    t("div", vb, [
                      t(
                        "button",
                        {
  ...
  var Eb = Y(Fb, [["__scopeId", "data-v-16746f19"]]);
  const st = (e) => (O("data-v-0d3a64fa"), (e = e()), N(), e),
    ...
    Db = st(() =>
      t(
        ...
        "Please make sure you have connected the routed WAN port to the superior routed local area network (LAN) port",
        -1,
      ),
    ),
    Bb = {
    ...
    Lb = st(() =>
      t(
        ...
        [t("span", null, "WAN Interface configuration method")],
        -1,
      ),
    ),
    Mb = st(() =>
    ...
    Zb = st(() =>
      t(
        ...
        [t("span", null, "DNS Configuration method")],
        -1,
      ),
    ),
    Jb = ["disabled"],
    ...
    bv = P({
      setup(e) {
          ...
          T(this, null, function* () {
            ...
            try {
              const A = yield Promise.all([
                S.Guide.ClientModel.GET(),
                S.Guide.GetLan.GET(),
              ]);
              if (A[0]) {
                const B = A[0];
                if (B.data) {
                  const { success: $, error: q, result: H } = B.data;
                  (H &&
                    (H.wanProto != "dhcp" &&
                      H.wanProto != "static" &&
                      ((H.wanProto = "dhcp"), (H.dnsProto = "auto")),
                    (H.enableLanDhcp = !1),
                    (o.value = H)),
                    $ == -1011 && ((l.value = $), (p.value = !0)));
                }
              }
              (x = A[1].data) != null &&
                x.result &&
                (((E = A[1].data) == null ? void 0 : E.result).enableDhcp ||
                  ((m.value = !0), (o.value.enableLanDhcp = !0)));
            } catch (A) {
              n.value = A;
            }
            l.value == 0 && (p.value = !1);
        ...
        const _ = (x) => {
            x.target.value == "static"
              ? ((o.value.staticIp == null || o.value.staticIp == "") &&
                  (o.value.staticIp = "192.168.1.100"),
                (o.value.subnetMask == null || o.value.subnetMask == "") &&
                  (o.value.subnetMask = "255.255.255.0"),
                o.value.dnsProto == "auto" &&
                  setTimeout(() => (o.value.dnsProto = "manual"), 0))
              : o.value.dnsProto == "manual" &&
                setTimeout(() => (o.value.dnsProto = "auto"), 0);
          },
          v = (x) => {
            const E = x.target;
            if (E.value == "") {
            ...
            u(E.value)
              ? (f.value = "")
              : (f.value = "Please enter a legal ip address");
          },
          g = (x) => {
            const E = x.target;
            if (E.value == "") {
            ...
            u(E.value)
              ? (d.value = "")
              : (d.value = "Please enter a legal address");
          },
          k = () =>
            T(this, null, function* () {
              const x = {};
              switch (o.value.wanProto) {
                case "dhcp":
                  break;
                case "static":
                  ((x.staticIp = o.value.staticIp),
                    (x.subnetMask = o.value.subnetMask),
                    (x.gateway = o.value.gateway));
                  break;
              }
                ...
                case "manual":
                  ((x.manualDnsIp = []),
                    ...
                    o.value.manualDnsIp.length > 0
                      ? (x.manualDnsIp = o.value.manualDnsIp)
                      : (x.manualDnsIp.push(s.value),
                        c.value && x.manualDnsIp.push(c.value)));
                  break;
              }
              ((x.dnsProto = o.value.dnsProto),
                (x.wanProto = o.value.wanProto),
                (x.enableLanDhcp = o.value.enableLanDhcp));
              const E = F.Loading("Configuration....");
              p.value = !0;
              try {
                const A = yield S.Guide.ClientModel.POST(x);
                if (A != null && A.data) {
                  const { success: B, error: $ } = A == null ? void 0 : A.data;
                  ($ && (n.value = $),
                    (B == null || B == 0) &&
                      (F.Success("配置成功"), (a.value = 1)));
                }
                ...
                t(
                  ...
                  [
                    ...
                    m.value
                      ...
                      : C("", !0),
                    n.value ? (i(), r("div", rv, h(n.value), 1)) : C("", !0),
                    t("div", sv, [
                      t(
                        "button",
                        {
  ...
  var vv = Y(bv, [["__scopeId", "data-v-0d3a64fa"]]);
  const lt = (e) => (O("data-v-1c3f186c"), (e = e()), N(), e),
    ...
    hv = lt(() =>
      t(
        ...
        [
          U(
            "Bypass routing mode is also called single-arm routing mode. You can use the upper level route (main route) to dial, and then use this route to realize some advanced functions. Wizard supports automatic or manual configuration.",
          ),
          t("br"),
          t("br"),
          U(
            "For manual configuration, you need to get yourself an ip address (example 192.168.1.1) and subnet mask from main router.",
          ),
        ],
        -1,
      ),
    ...
    Fv = lt(() =>
      t(
        ...
        "Now, please configure the bypass route information",
        -1,
      ),
    ),
    Ev = ["onSubmit"],
    Cv = lt(() =>
      t(
        ...
        [t("span", null, "LAN Interface configuration mode")],
        -1,
      ),
    ),
    $v = {
    ...
    Dv = lt(() =>
      t(
        "option",
        null,
        "Bypass router mode only supports IP address static",
        -1,
      ),
    ),
    Bv = [Dv],
    ...
    Rv = lt(() =>
      t(
        ...
        "Now, disconnect WAN port of this router, connect one of LAN ports to the main router, and connect the current browser device to the main router. Click '' browser will jump to new routing ip",
        -1,
      ),
    ),
    Uv = {
    ...
    Wv = lt(() =>
      t(
        ...
        "Bypass Router Auto-Configuration",
        -1,
      ),
    ),
    Hv = lt(() =>
      t(
        ...
        [
          U(
            "Confirm main router has opened DHCP service, and confirm WAN port of route in DHCP client mode.",
          ),
          t("br"),
          U(
            "(if not, you can use \u0022Router\u0022 wizard for change it to DHCP client)",
          ),
          t("br"),
          t("br"),
          U(
            "Connect WAN port of route to main router. Routed LAN connections to get configuration automatically.",
          ),
        ],
        -1,
      ),
    ...
    Zv = U(
      "After meeting all conditions, click \u0022Current IPv4 Upstream information\u0022 to refresh the current connection information. Once successfully, \u0022Auto fill\u0022 button will be activated. If you fail, you can click again",
    ),
    Jv = ["disabled"],
    ...
    Qv = U(
      "Click \u0022Auto Fill\u0022, it will switch to parameter page and fill in automatically. You can still adjust the parameters yourself.",
    ),
    tg = {
      class: "btns",
    },
      ...
      setup(e) {
        const a = y(0),
          ...
          s = R(() => {
            var m, b, _;
            return !(
              ((m = p.value) == null ? void 0 : m.ipv4addr) &&
              ((b = p.value) == null ? void 0 : b.ipv4mask) &&
              ((_ = p.value) == null ? void 0 : _.gateway)
            );
          }),
          c = y({
          ...
          d = (m) => {
            ...
            (m &&
              ((c.value.staticLanIp =
                ((b = p.value) == null ? void 0 : b.ipv4addr) || ""),
              (c.value.subnetMask =
                (((_ = p.value) == null ? void 0 : _.ipv4mask) &&
                  xt.prefixToMask(p.value.ipv4mask)) ||
                ""),
              (c.value.gateway =
                ((v = p.value) == null ? void 0 : v.gateway) || ""),
              (c.value.staticDnsIp =
                (((g = p.value) == null ? void 0 : g.dnsList) &&
                  ((k = p.value) == null ? void 0 : k.dnsList[0])) ||
                "8.8.8.8")),
              (a.value = 1));
          },
          l = (m) => {
          ...
          u = () =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (_ != null && _.data) {
                  const { success: v, error: g } = _ == null ? void 0 : _.data;
                ...
                r("div", wv, [
                  ...
                  t(
                    ...
                    [
                      ...
                      o.value ? (i(), r("div", Pv, h(o.value), 1)) : C("", !0),
                      t("div", Tv, [
                        D(
                          v,
                          {
                            ...
                            "onUpdate:modelValue":
                              b[6] || (b[6] = (A) => (c.value.enableDhcp = A)),
                          },
                          {
                            default: V(() => [
                              c.value.enableDhcp
                                ? (i(),
                                  r("span", Iv, [
                                    U("Provide DHCPv4 service"),
                                    t("br"),
                                    U(
                                      "(main router DHCP service needs to be turned off)",
                                    ),
                                  ]))
                                : (i(),
                                  r("span", Lv, "Provide DHCPv4 service")),
                            ]),
                            _: 1,
                          },
                          8,
                      ...
                      t(
                        "button",
                        {
                          class: ot([
                            ...
                            w(s) ? "cbi-button-neutral" : "cbi-button-success",
                          ]),
                          style: {
                            "line-height": "2",
                            margin: "2rem 0",
                          ...
                          t("p", Kv, [
                            t("ul", null, [
                              t(
                                ...
                                "IP address: " +
                                  h(
                                    (g = p.value) == null ? void 0 : g.ipv4addr,
                                  ),
                                1,
                              ),
                              t(
                                ...
                                "Subnet mask: " +
                                  h(
                                    ((k = p.value) == null
                                      ? void 0
                                      : k.ipv4mask) &&
                                      w(xt).prefixToMask(p.value.ipv4mask),
                                  ),
                                1,
                              ),
                              t(
                                ...
                                null,
                                "Gateway address: " +
                                  h((x = p.value) == null ? void 0 : x.gateway),
                                1,
                              ),
                              t(
                                "li",
                                ...
                                "DNS server: " +
                                  h(
                                    (((E = p.value) == null
                                      ...
                                      (w(s)
                                        ? ""
                                        : "(No DNS server, please fill in the public DNS server later, for example 8.8.8.8)"),
                                  ),
                                1,
                              ),
                            ]),
                      ...
                      t("div", tg, [
                        t(
                          ...
                          "Auto fill" +
                            h(
                              w(s)
                                ? " (Please obtain IPv4 Upstream information first!)"
                                : "",
                            ),
                          9,
                          eg,
  ...
  var ng = Y(og, [["__scopeId", "data-v-1c3f186c"]]);
      ...
      setup(e) {
        ...
        (() =>
          T(this, null, function* () {
            ...
            try {
              ...
              if (g != null && g.data) {
                const { success: k, error: x, result: E } = g.data;
        ...
        const v = () =>
          T(this, null, function* () {
            ...
            if (
              !!confirm(
                `\u662F\u5426\u7ACB\u5373\u521B\u5EFA ${g.name}\uFF1F\u9009\u62E9\u7684\u786C\u76D8\u6240\u6709\u5206\u533A\u5C06\u4F1A\u88AB\u6E05\u9664\uFF0C\u6B64\u64CD\u4F5C\u53EF\u80FD\u4F1A\u5BFC\u81F4\u786C\u76D8\u6570\u636E\u4E22\u5931\uFF0C\u8BF7\u8C28\u614E\u64CD\u4F5C\u3002`,
              ) &&
              !!confirm(
                `\u786E\u5B9A\u521B\u5EFA ${g.name}\uFF1F\u8BE5\u64CD\u4F5C\u4E0D\u53EF\u9006,\u8BF7\u8C28\u614E\u64CD\u4F5C`,
              )
            ) {
              ...
              try {
                ...
                if (x.data) {
                  const { success: E, error: A, result: B } = x.data;
                  if (A) throw A;
                  ...
                  : s.value == "error"
                    ? (i(),
                      r(
                        ...
                        [
                          t("div", Bg, [D(E), t("span", null, h(c.value), 1)]),
                          t("div", Yg, [
                            t(
                              "div",
                              {
  ...
  var Ig = Y(Tg, [["__scopeId", "data-v-7fc91c6d"]]);
  const Lg = {
      class: "actioner-container",
    },
    Mg = {
        ...
        return (
          (() => {
            S.Raid.Detail.POST({
              ...
              .then((c) => {
                if (c.data) {
                  const { result: p, error: f } = c.data;
                  f
                    ? (n.value = f)
                    : (n.value = (p == null ? void 0 : p.detail) || "");
                }
              })
              .catch((c) => {
                n.value = c.message;
  ...
  var qg = Y(Ng, [["__scopeId", "data-v-51f9d7a2"]]);
          ...
          s = () =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (m.data) {
                  const { error: b, success: _ } = m.data;
                  if (b) throw b;
                  (_ || 0) == 0 &&
                    (F.Success("\u4FDD\u5B58\u6210\u529F"), n(), o());
                }
          ...
          (() =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (l != null && l.data) {
                  const { success: u, error: m, result: b } = l.data;
  ...
  var s_ = Y(r_, [["__scopeId", "data-v-c07c8244"]]);
    ...
    w_ = P({
      ...
      setup(e) {
          ...
          s = () =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (l.data) {
                  const { error: u, success: m } = l.data;
                  if (u) throw u;
                  (m || 0) == 0 &&
                    (F.Success("\u4FDD\u5B58\u6210\u529F"), n(), o());
                }
        ...
        return (f, d) => (
          ...
          r("div", d_, [
            t("div", u_, [
              t("span", null, "RAID - " + h(e.raid.name) + " \u79FB\u9664", 1),
            ]),
            t("div", l_, [
              t("div", c_, [
                p_,
  ...
  var y_ = Y(w_, [["__scopeId", "data-v-13dc2cd6"]]);
  ...
  var G_ = Y(V_, [["__scopeId", "data-v-5643983d"]]);
  const j_ = {
      class: "action-main",
    },
    R_ = P({
  ...
  var U_ = Y(R_, [["__scopeId", "data-v-6ef94d02"]]);
  const Jt = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
    ...
    kh = P({
      setup(e) {
          ...
          o = () =>
            T(this, null, function* () {
              try {
                ...
                if (v != null && v.data) {
                  const { success: g, error: k, result: x } = v.data;
        ...
        const s = (v) => {
            ...
            return (
              v.status.indexOf("degraded") != -1 ||
              v.status.indexOf("resyncing(") != -1
            );
          },
          c = (v) => {
            let g = [];
          ...
          d = (v) =>
            T(this, null, function* () {
              if (
                ...
                v.childrens.filter((x) => x.mountPoint).length > 0
              ) {
                de(
                  mountsFeature
                    ? {
                    ...
                    : {
                        content:
                          "\u5220\u9664 RAID \u8BBE\u5907\u4E4B\u524D\u8BF7\u5148\u5378\u8F7D\u6587\u4EF6\u7CFB\u7EDF\u3002\u5F53\u524D\u7CFB\u7EDF\u672A\u68C0\u6D4B\u5230\u201C\u6302\u8F7D\u70B9\u201D\u9875\u9762\uFF0C\u8BF7\u4ECE\u7CFB\u7EDF\u83DC\u5355\u624B\u52A8\u5378\u8F7D\u540E\u518D\u8BD5\u3002",
                        nextTitle: "\u77E5\u9053\u4E86",
                        next: () => {},
                      },
                );
              ...
              if (
                !confirm(
                  `\u786E\u5B9A\u8981\u5220\u9664 ${v.name} \u8BE5\u78C1\u76D8\u9635\u5217\u5417\uFF1F\u5220\u9664\u64CD\u4F5C\u53EF\u80FD\u4F1A\u5BFC\u81F4\u6570\u636E\u4E22\u5931\uFF0C\u8BF7\u8C28\u614E\u64CD\u4F5C\u3002\u5220\u9664\u6210\u529F\u540E\uFF0C\u5982\u9700\u53E6\u5916\u7EC4RAID\uFF0C\u5EFA\u8BAE\u7A0D\u7B49\u51E0\u5206\u949F\u540E\u518D\u8BD5\u3002`,
                ) ||
                !confirm(`\u786E\u5B9A\u8981\u5220\u9664 ${v.name} \u5417?`)
              )
                return;
              ...
              try {
                ...
                if (k.data) {
                  const { success: x, error: E } = k.data;
                  if (E) throw E;
              ...
              next: () =>
                T(this, null, function* () {
                  ...
                  try {
                    ...
                    if (g.data) {
                      const { error: k, success: x } = g.data;
                      if (k) throw k;
                      (x || 0) == 0 &&
                        (F.Success("\u6062\u590D\u5B8C\u6210"), o());
                    }
                    ...
                    r(
                      ...
                      j(
                        ...
                        (k) => (
                          i(),
                          r("tr", ah, [
                            t("td", oh, [t("b", null, h(k.name), 1)]),
                            t("td", nh, [t("b", null, h(k.path), 1)]),
                            t(
                              "td",
                              {
                                class: "td cbi-value-field",
                            ...
                            t("td", dh, [t("b", null, h(k.level), 1)]),
                            t("td", uh, [t("b", null, h(k.size), 1)]),
                            t("td", lh, [
                              (i(!0),
                              r(
                                L,
  ...
  var wh = Y(kh, [["__scopeId", "data-v-535a673b"]]);
      ...
      t(
        ...
        [
          t(
            "p",
            null,
            "Automatic hard drive status detection and early warning specification system through detection clues in hard drive hardware, such as magnetic heads, disks, and drive motors.",
          ),
          t(
            "p",
            null,
    ...
    Dh = P({
      setup(e) {
        const a = [
          ...
          s = (f) => {
            const { global: d, devices: l, tasks: u } = f;
            (d &&
              ((n.global.enable = d.enable || !1),
              (n.global.powermode = d.powermode || "never")),
              (n.devices = l || []),
              (n.tasks = u || []));
          };
        (() =>
  ...
  var Bh = Y(Dh, [["__scopeId", "data-v-2bc40d1c"]]);
  const Yh = {
      class: "action-main",
    },
    Ah = P({
      setup(e) {
        return (a, o) => (
          ...
          M(
            ...
            {
              default: V(() => [
                t("div", Yh, [Dt(a.$slots, "default", {}, void 0, !0)]),
              ]),
              _: 3,
            },
          )
  ...
  var he = Y(Ah, [["__scopeId", "data-v-742230ae"]]);
  const Sh = {
      class: "actioner-container",
    },
    zh = {
    ...
    Nh = t(
      ...
      "Temperature Monitoring (Difference)",
      -1,
    ),
    qh = {
      class: "cbi-value-field",
    ...
    Uh = t(
      ...
      "Report if temperature has changed by at least N degrees since the last report.",
      -1,
    ),
    Wh = {
      class: "cbi-value",
    ...
    Hh = t(
      ...
      "Temperature Monitoring (Maximum)",
      -1,
    ),
    Zh = {
      class: "cbi-value-field",
    ...
    tx = t(
      ...
      "Report if temperature is greater than or equal to N degrees Celsius.",
      -1,
    ),
    ex = {
      class: "actioner-container_footer",
        ...
        return (l, u) => (
          ...
          M(he, null, {
            default: V(() => [
              t("div", Sh, [
                t("div", zh, [
                  t("span", null, " S.M.A.R.T Disk \xBB " + h(e.disk.path), 1),
                ]),
                t("div", Ph, [
                  t("div", Th, [
                    Ih,
    ...
    rx = t(
      ...
      [t("span", null, "Create a scheduled task")],
      -1,
    ),
    sx = {
      class: "actioner-container_body",
          ...
          l = () =>
            T(this, null, function* () {
              ...
              try {
                ...
                if (u.data) {
                  const { success: m, error: b, result: _ } = u.data;
...
` +
  ...
  var ok = Y(ak, [["__scopeId", "data-v-3f7c551e"]]);
          ...
          d = () =>
            T(this, null, function* () {
              try {
                ...
                if (u.data) {
                  const { result: m, error: b } = u.data;
                  (m && m.result && (p.attribute = m.result),
                    b && (p.attribute = b));
                }
              } catch (u) {
                p.attribute = u;
              ...
              t("div", nk, [
                ...
                t("div", bk, [
                  n.value == "info"
                    ? (i(),
                      r("table", vk, [
                        t("tr", gk, [_k, t("td", hk, h(e.disk.path), 1)]),
                        t("tr", xk, [kk, t("td", wk, h(e.disk.model), 1)]),
                        t("tr", yk, [Fk, t("td", Ek, h(e.disk.serial), 1)]),
                      ]))
                    : n.value == "attribute"
                      ? (i(),
                        r(
  ...
  var Sk = Y(Ak, [["__scopeId", "data-v-7d3ebf99"]]);
  const zk = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = D(
    ...
    Kk = t(
      ...
      [
        t(
          "span",
          null,
          "The disk will rotate during the test, please select the appropriate mode to control the rotation of the disk.",
        ),
        t("br"),
        t(
          "span",
          null,
          "Always test to check the disk no matter what power mode it is in, when checking, this may cause a stalled disk to start spinning.",
        ),
        t("br"),
        t("span", null, "Sleep In sleep mode the device is not checked."),
        t("br"),
        t(
          "span",
          null,
          "Standby does not check the device in standby and sleep mode. In this mode, the disk generally does not rotate. If you don't want to rotate the disk every time you check, then this mode is more suitable.",
        ),
        t("br"),
        t(
          "span",
          null,
          "Idle does not check devices in standby, sleep, idle mode, and in idle most disks are still spinning, so this might not work for you.",
        ),
      ],
      -1,
    ),
    ...
    $w = P({
      ...
      setup(e) {
        const a = e,
          o = it(a.config),
          n = () => {
            ((o.global.tmpDiff = a.config.global.tmpDiff || 0),
              (o.global.tmpMax = a.config.global.tmpMax || 0),
              (o.global.enable = a.config.global.enable || !1),
              (o.global.powermode = a.config.global.powermode || "never"),
              (o.devices = a.config.devices || []),
          ...
          l = (u, m) =>
            T(this, null, function* () {
              ...
              zk({
                ...
                next: (v) =>
                  T(this, null, function* () {
                    (v.tmpDiff == -1 && (v.tmpDiff = o.global.tmpDiff),
                      v.tmpMax == -1 && (v.tmpMax = o.global.tmpMax),
                      v.devicePath == "" && (v.devicePath = u.path));
                    let g = [...o.devices];
                    _ >= 0 && (g[_] = v);
                    const k = new Map();
                    g.forEach((x) => {
                      ...
                      z(
                        t(
                          "select",
                          {
                            class: "cbi-input-select",
                            "onUpdate:modelValue":
                              m[2] || (m[2] = (b) => (w(o).global.tmpDiff = b)),
                          },
                          [
                            ow,
                            (i(),
                    ...
                    r(
                      ...
                      j(
                        ...
                        (b, _) => (
                          i(),
                          r("tr", vw, [
                            t("td", gw, [t("b", null, h(b.path), 1)]),
                            t("td", _w, [t("b", null, h(b.model), 1)]),
                            t("td", hw, [t("b", null, h(b.serial), 1)]),
                            t("td", xw, [t("b", null, h(b.sizeStr), 1)]),
                            t("td", kw, [t("b", null, h(b.temp), 1)]),
                            t("td", ww, [t("b", null, h(b.status), 1)]),
                            t("td", yw, [t("b", null, h(b.health), 1)]),
                            t("td", Fw, [
                              t(
                                "button",
                                {
                    ...
                    r(
                      ...
                      j(
                        ...
                        (l, u) => (
                          i(),
                          r("tr", Aw, [
                            t("td", Sw, [t("b", null, h(l.devicePath), 1)]),
                            t("td", zw, [t("b", null, h(n(l.type)), 1)]),
                            t("td", Pw, [
                              t(
                                "b",
                                null,
  ...
  var Vw = Y(qw, [["__scopeId", "data-v-76197cba"]]);
  const Gw = {},
    jw = {
      t: "1659511092204",
      class: "icon",
  ...
  const xe = (e) => (O("data-v-2f7b866f"), (e = e()), N(), e),
    ...
    oy = xe(() =>
      t(
        ...
        [t("span", null, "Protocol (Network Acquisition Method)")],
        -1,
      ),
    ),
    ny = {
                      ...
                      t("div", Qw, [
                        ...
                        t("div", ey, [
                          t(
                            "span",
                            null,
                            h(n.value.name.toLocaleUpperCase()),
                            1,
                          ),
                        ]),
                      ]),
  ...
  var cy = Y(ly, [["__scopeId", "data-v-2f7b866f"]]);
  const Je = (e) => {
      const a = document.createElement("div");
      document.body.appendChild(a);
      const o = tt(
      ...
      setup(e) {
        ...
        const c = (m, b) => {
            ...
            if (b == null) {
              ...
              (_ == 6 && m == "wan" && _++,
                Je({
                  ...
                  next: (v) => {
                    (m == "wan" ? n.wan.push(v) : n.lan.push(v),
                      F.Message(
                        "Please go to the 'Network-Interface' page to configure detailed parameters of the interface",
                      ));
                  },
                }));
            } else
          ...
          d = (m, b) => {
            ...
            g != -1
              ? n.lan[b].deviceNames.splice(g, 1)
              : (n.lan[b].deviceNames === null && (n.lan[b].deviceNames = []),
                n.lan[b].deviceNames.push(v));
          },
          l = (m, b) => {
            const v = m.target.value;
          ...
          u = () =>
            T(this, null, function* () {
              ...
              for (let _ = 0; _ < n.lan.length; _++) {
                ...
                if (
                  v.name === "lan" &&
                  (!v.deviceNames || v.deviceNames.length == 0) &&
                  !confirm(
                    "LAN port is not associated with any physical network port, which may cause the router to lose connection. Do you want to continue?",
                  )
                ) {
                  o.value = !1;
                  return;
              ...
              try {
                ...
                if (_.data) {
                  const { success: v, result: g, error: k } = _.data;
                  if (k) throw k;
  ...
  var Qy = Y(Ky, [["__scopeId", "data-v-589588f0"]]);
