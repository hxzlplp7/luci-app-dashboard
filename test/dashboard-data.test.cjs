...
test('filters non-domain tokens from domain rows', () => {
    const rows = helpers.filterDomainRows([
        ...
        { domain: 'openclash.sh', count: 1 },
        { domain: 'cron.err', count: 1 },
        { domain: 'daemon.info', count: 151 },
        { domain: 'l0aqo.js', count: 1 },
        { domain: 'game-rules-manage.lua', count: 1 },
        { domain: 'index-dnshuhfc.js', count: 1 },
        { domain: 'rules.list', count: 1 },
        { domain: 'fontawesome.woff2', count: 1 },
        { domain: 'proxies-lk5uj4lx.js', count: 1 },
        { domain: 'index-drfvup5k.css', count: 1 },
        { domain: 'monster-hunter-world.rules', count: 1 },
        { domain: 'fira-sans-cyrillic-ext-400-normal-dd5dapay.woff', count: 1 },
        { domain: 'idea.css', count: 1 },
